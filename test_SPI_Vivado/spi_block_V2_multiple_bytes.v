...
module spi_block_V2 #(
    ...
    localparam S_LOAD_ADDR  = 4'b0010;
    localparam S_LOAD_DATA  = 4'b0100;
    localparam S_READ_DATA  = 4'b1000;
    ...
    assign spi_clk_o = (state != S_IDLE) ? clk_spi : 1'b1;
...
//////SLOW CLOCK DOMAIN
    ...
    assign spi_data_o = shift_reg_tx[SH_REG_SIZE - 1];
    ...
    always @(posedge clk_spi or posedge reset_i) begin
		if(reset_i)
			...
			shift_reg_rx <= #TP {shift_reg_rx[6 : 0], spi_data_i};
    end
