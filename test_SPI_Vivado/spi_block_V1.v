...
always @ (posedge clk_i or posedge reset_i) begin
    if (reset_i)
        ...
        shift_reg <= #TP (shift_reg << 1) | spi_data_i;
    else if (req_i)
...
always @ (posedge clk_i or negedge reset_i) begin
    if (!reset_i)
        ...
        shift_reg <= {is_read_op, 1'b0, addr_i, wr_data_i};
end
