...
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { stop_motion }]; #IO_L9P_T1_DQS_34 Sch=sw[3]

##Buttons
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { rst }]; #IO_L12N_T1_MRCC_35 Sch=btn[0]
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { advance_frame_btn }]; #IO_L12N_T1_MRCC_35 Sch=btn[0]

##LEDs
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { led_btn }]; #IO_L23P_T3_35 Sch=led[0]
